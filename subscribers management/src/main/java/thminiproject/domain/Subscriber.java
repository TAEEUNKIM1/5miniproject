...
import lombok.Data;
import thminiproject.SubscribersManagementApplication;
import thminiproject.domain.ContentViewEnabled;
import thminiproject.domain.Login;
import thminiproject.domain.Logout;
import thminiproject.domain.PointsAdded;
import thminiproject.domain.PointsUsed;
import thminiproject.domain.SignedIn;
